...
bool Setup()
{
	...
	if (FAILED(D3DXCreateTextureFromFile(Device,"crate.jpg",&BkGndTex)))
	{
		if (FAILED(D3DXCreateTextureFromFile(Device,"..\\MtrlAlpha\\crate.jpg",&BkGndTex)))
		{
			MessageBox(NULL, "未能加载资源", "提示", MB_OK);
			return false;
		}
	}
